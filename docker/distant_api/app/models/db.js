...
async function createTables() {
  try {
    ...
    await connection.execute("CREATE TABLE IF NOT EXISTS Buildings (id VARCHAR(36) PRIMARY KEY, name VARCHAR(255), createdBy VARCHAR(36), FOREIGN KEY (createdBy) REFERENCES Users(id));");
