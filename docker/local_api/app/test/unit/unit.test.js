...
describe('Controller User', () => {
  ...
  it('Delete/', async () => {
    ...
    const signupResponse = await axios.post('http://localhost:80/user/signup', {
      name: 'john',
    ...
    const getResponse = await axios.get('http://localhost:80/user');
  ...
  it('Update/', async () => {
    ...
    const updateResponse = await axios.patch(`http://localhost:80/user/${signupId}`, {
      name: 'jack',
  ...
  it('Get Id /', async () => {
    ...
    const getResponse = await axios.get(`http://localhost:80/user/${userId}`);
